...
\begin{center}
\renewcommand{\arraystretch}{1.25}
\begin{tabular}{p{0.28\linewidth} c p{0.28\linewidth} c p{0.28\linewidth}}
{\LARGE\bf Direct} & & {\LARGE\bf Lazy} & & {\LARGE\bf Iterative} \\
Read from the file and return an array. & & Get an object that reads on demand. & & Read arrays in batches of entries. \\
